...
contract Traits is Ownable {
  ...
  function drawSVG(uint256 tokenId) public view returns (string memory) {
    ...
    string memory svgString = string(abi.encodePacked(
      drawTrait(traitData[0][c.helmet]),
      drawTrait(traitData[1][c.ears]),
      drawTrait(traitData[2][c.body]),
      drawTrait(traitData[3][c.chest]),
      drawTrait(traitData[4][c.mainhand]),
      drawTrait(traitData[5][c.offhand]),
      drawTrait(traitData[6][c.legs]),
      drawTrait(traitData[7][c.feet])
    ));
  ...
  function compileAttributes(uint256 tokenId) public view returns (string memory) {
    ...
    traits = string(abi.encodePacked(
        attributeForTypeAndValue(_traitTypes[0], traitData[0][c.helmet].name),',',
        attributeForTypeAndValue(_traitTypes[1], traitData[1][c.ears].name),',',
        attributeForTypeAndValue(_traitTypes[2], traitData[2][c.body].name),',',
        attributeForTypeAndValue(_traitTypes[3], traitData[3][c.chest].name),',',
        attributeForTypeAndValue(_traitTypes[4], traitData[4][c.mainhand].name),',',
        attributeForTypeAndValue(_traitTypes[5], traitData[5][c.offhand].name),',',
        attributeForTypeAndValue(_traitTypes[6], traitData[6][c.legs].name),',',
        attributeForTypeAndValue(_traitTypes[7], traitData[7][c.feet].name),',',
        attributeForTypeAndValue(_traitTypes[8], _ranks[uint256(c.rank)]),','
    ));
